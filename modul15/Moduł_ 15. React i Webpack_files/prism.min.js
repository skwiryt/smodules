/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+basic+batch+c+csharp+cpp+css-extras+docker+git+http+java+javadoc+javadoclike+jsdoc+js-extras+json+json5+jsonp+kotlin+markdown+markup-templating+nginx+pascal+php+plsql+powershell+python+regex+ruby+rust+scss+shell-session+sql+typescript&plugins=line-numbers+remove-initial-line-feed+normalize-whitespace */
